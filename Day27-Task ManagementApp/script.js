...
// Task 3: Add a form to the HTML structure with fields for entering task details(title, description, due data). Style the form using Css.

// Task 4: Write a script to handle form submission, creating a new task object and adding it to array of tasks. Display the new task in the task list.
...
// Task 10: Add a confirmation dialog before delecting a task to prevent accidental delections. 